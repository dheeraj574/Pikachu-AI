...
import { Zap, Mail, Lock, Chrome, ArrowRight, BookOpen } from 'lucide-react';
      ...
      <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="space-y-8">
          <div className="flex items-center gap-2 text-primary">
            ...
            <span className="font-bold text-3xl tracking-tight">Pikachu AI</span>
          </div>

          <div className="space-y-2">
            <h1 className="text-4xl font-bold tracking-tight">Welcome back</h1>
            <p className="text-muted-foreground">Log in to your university account to continue.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-primary text-primary-foreground py-3 rounded-lg font-bold hover:opacity-90 transition-opacity flex items-center justify-center gap-2">
          ...
          <button className="w-full border border-border bg-card py-2.5 rounded-lg font-medium hover:bg-secondary transition-colors flex items-center justify-center gap-2">
        ...
        <div className="hidden md:block">
          <div className="bg-secondary rounded-[40px] p-12 aspect-square flex flex-col justify-center items-center text-center space-y-6 relative overflow-hidden">
             ...
             <div className="space-y-2 relative z-10">
               ...
               <p className="text-muted-foreground">All your university resources, powered by AI, in one clean platform.</p>
             </div>
          </div>
        </div>
      </div>
